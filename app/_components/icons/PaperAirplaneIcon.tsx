...
export default function PaperAirplaneIcon({ className, ...props }: PaperAirplaneIconProps) {
  return (
    <svg
      ...
      className={className}
      {...props} // Spread other props like `aria-label`, `onClick`, etc.
    >
      <g>
        <g>
          <g>
            <path
              d="M184.439,480.989c3.706-3.727,9.762-3.746,13.487-0.039c3.726,3.705,3.746,9.763,0.04,13.486l-47.814,47.854
            ...
            />
            <path
              d="M174.876,427.458c-3.706-3.727-3.686-9.782,0.04-13.487s9.782-3.687,13.487,0.039l106.685,106.705L592.87,92.619v-3.467
