...
const getAnswerSystemPrompt = ({ question, userAnswer }: GenerateFeedbackAnswerRequest) => {
...
const getQuestionSystemPrompt = ({ devType, topics, subTopics }: GenerateQuestionRequest) => {
...
/** 공통 fetch 로직 */
async function getChatMessage<T>(
  systemPrompt: string,
  userPrompt: string,
